...
from app.api import accounts, auth, drafts, media, oauth, posts
...
for _router in (auth.router, drafts.router, posts.router, media.router, accounts.router, oauth.router):
